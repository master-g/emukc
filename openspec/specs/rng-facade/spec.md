...
RNG facade for EmuKC. Provides a single-point backend (`emukc_crypto::rng`) with
thread-local free functions and seeded `GameRng` instances for deterministic replay.
