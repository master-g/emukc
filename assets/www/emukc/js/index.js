...
var gadgetInfo = {
	...
	OWNER_ID: dmmUid,
	APP_ID: 854854,
	URL: `/gadgets/ifr.html?synd=dmm&container=dmm&owner=${dmmUid}&viewer=${dmmUid}&aid=${dmmUid}&mid=29080258&country=jp&lang=ja&view=canvas&parent=${parent}&url=${url}&st=${st}#rpctoken=1131055973`,
	FRAME_ID: "game_frame",
	ST: st,
	TIME: Date.now() / 1000,
	TYPE: "",
...
DMM.netgame = (function () {
	...
	return {
		...
		requestRedirect: function (callbackurl) {
			...
			var url =
				location.pathname + "?url=" + encodeURIComponent(callbackurl);
			location.href = url;
		},
