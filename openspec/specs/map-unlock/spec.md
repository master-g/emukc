## Purpose
Map unlock progression for EmuKC. Defines how maps become available to players
through a prerequisite chain, per-player unlock tracking, sortie gating, unlock
cascades on map clear, and migration of existing accounts.
