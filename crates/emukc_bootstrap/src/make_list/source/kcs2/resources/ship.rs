...
/// Friend-fleet graph ids (>= 5000) whose character artwork is absent from the CDN.
///
/// These ids exist in `api_mst_shipgraph` but not in `api_mst_ship`, so nothing
/// but a CDN probe tells them apart from a published friend fleet. 6299/6301/6303
/// were confirmed by a full `cache populate` sweep of the generated list.
static EVENT_SHIP_HOLES: LazyLock<ShipPathHoles> = LazyLock::new(|| ShipPathHoles {
    full: vec![
        ...
        6233, 6234, 6235, 6236, 6237, 6238, 6239, 6240, 6241, 6242, 6244, 6245, 6246, 6247, 6248,
        6249, 6250, 6251, 6252, 6253, 6254, 6255, 6256, 6257, 6258, 6259, 6260, 6261, 6262, 6299,
        6301, 6303,
    ],
    full_dmg: vec![
        ...
        6241, 6242, 6244, 6245, 6246, 6247, 6248, 6249, 6250, 6251, 6252, 6253, 6254, 6255, 6256,
        6257, 6258, 6259, 6260, 6261, 6262, 6299, 6301, 6303,
    ],
    up: vec![
        5358, 5514, 5526, 5527, 5530, 5531, 5532, 5534, 5536, 5848, 5849, 5850, 5851, 5852, 5853,
        6233, 6234, 6235, 6236, 6237, 6238, 6239, 6240, 6241, 6242, 6244, 6245, 6246, 6247, 6248,
