# rules-default-strategy Specification

## Purpose
Defines the behavior of `CacheListMakeStrategy::Default` and `Greedy` after migration to the decoder-driven rules pipeline.
