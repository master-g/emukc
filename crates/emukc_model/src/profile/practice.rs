...
impl From<Rival> for KcApiPracticeEnemyInfo {
	fn from(value: Rival) -> Self {
		Self {
			...
			api_experience: [value.details.exp_now, value.details.exp_next],
			api_friend: value.details.friend,
			api_ship: [value.details.current_ship_count, value.details.ship_capacity],
			api_slotitem: [value.details.current_slot_item_count, value.details.slot_item_capacity],
